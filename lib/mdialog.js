...
var Dialog = function(conf) {
    ...
    this.unknown = !conf.width && !conf.height; // 不确定宽高
...
Dialog.prototype = {
    ...
    init: function() {
        ...
        addEvent(window, 'resize', function() {
            var ws = GetWinSize();
            this._winWidth = ws.width;
            this._winHeight = ws.height;
            this.adjust();
        }.bind(this));
    },
    ...
    adjust: function() {
        if(!this.unknown || this.main.scrollHeight <= this.wrapper.clientHeight) return;
